...
public class SendingEmail {
    private static final String MAIL_PASS = "iljkmqlxkwtbcgii";
    private static final String USER_EMAIL = "lebdatest@gmail.com";
    private static final String FROM = "lebdatest@gmail.com";
